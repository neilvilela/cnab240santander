module Cnab240santander
  class TrailerLote < Cnab240santander::Base
    def self.processar(linha)
      ...
      vlinha["valor_titulos_cobranca_simples"]     = prepara_moeda(linha[29..45], 2) #Num  //Valor total dos titulos cobranca simples - 2 decimais
      vlinha["qtde_titulos_cobranca_vinculada"]    = linha[46..51] #Num  //Quantidade de titulos em cobranca vinculada
      vlinha["valor_titulos_cobranca_vinculada"]   = prepara_moeda(linha[52..68], 2) #Num  //Valor total dos titulos em cobranca vinculada - 2 decimais
      vlinha["qtde_titulos_cobranca_caucionada"]   = linha[69..74] #Num  //Quantidade de titulos em cobranca caucionada
      vlinha["valor_titulos_cobranca_caucionada"]  = prepara_moeda(linha[75..91], 2) #Num  //Valor total dos titulos em cobranca caucionada  - 2 decimais
      vlinha["qtde_titulos_cobranca_descontada"]   = linha[92..97] #Num  //Quantidade de titulos em cobranca descontada
      vlinha["valor_titulos_cobranca_descontada"]  = prepara_moeda(linha[98..114], 2) #Num  //Valor total dos titulos em cobranca descontada  - 2 decimais
